...
let expName = 'TaskSwitching-proto';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'TESTING\n\n*note to have images of stimuli in here\n*instructions with examples\n\n\npress space to continue',
    font: 'Arial',
    units: undefined, 
  ...
  instruction_1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruction_1',
    text: "press 'left' if you see a triangle\npress 'right' if you see a square",
    font: 'Arial',
    units: undefined, 
  ...
  instruction_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruction_2',
    text: "press 'b' if you see one dot\npress 'n' if you see two dots\n",
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.1,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
function practice1RoutineBegin(trials) {
  return function () {
    ...
    stim_practice1.setPos([loc1, loc2]);
...
function practice2RoutineBegin(trials) {
  return function () {
    ...
    stim_practice2.setPos([loc1, loc2]);
